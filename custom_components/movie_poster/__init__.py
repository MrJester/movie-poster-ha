...
async def async_setup_entry(hass: HomeAssistant, entry: MoviePosterConfigEntry) -> bool:
    ...
    coordinator = MoviePosterCoordinator(
        ...
        show_title=entry.options.get(CONF_SHOW_TITLE, DEFAULT_SHOW_TITLE),
        show_subtitle=entry.options.get(CONF_SHOW_SUBTITLE, DEFAULT_SHOW_SUBTITLE),
        show_year=entry.options.get(CONF_SHOW_YEAR, DEFAULT_SHOW_YEAR),
        show_rating=entry.options.get(CONF_SHOW_RATING, DEFAULT_SHOW_RATING),
        show_runtime=entry.options.get(CONF_SHOW_RUNTIME, DEFAULT_SHOW_RUNTIME),
